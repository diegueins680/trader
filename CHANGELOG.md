...
- Web UI: reject fractional and unsafe integer-backed optimizer combo fields during combo import/apply instead of truncating them into different bars/epochs/lookback settings.
