...
- CLI/Duration parsing: reject overflowed integer literals instead of accepting wrapped values for `--bars`, `--lookback-window`, and numeric `--from/--to` timestamps (bounded `Int`/`Int64` parsing).
