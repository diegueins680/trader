...
- Required secret for autoloop: `OPENAI_API_KEY`.
...
- If `OPENAI_API_KEY` is missing, unauthorized, or out of quota, the workflow emits a warning and exits cleanly instead of failing the whole run.
