...
The research-only market-context artifact consumes an abstract scoped factor value directly. That value retains the validated target, quote, selected peer identities, bar, interval, and feature row; its private constructor prevents callers from relabeling a generic row as evidence from another scope.
