...
| RESEARCH-RATE-LIMIT-001 | Shared-IP Binance throttling can interrupt prospective derivatives collection and create irrecoverable acquisition gaps | HIGH | trader-firm-research | MITIGATED | Use conservative local budgets and stop all later requests on throttling; monitor gaps and move collection to stable persistent egress |
