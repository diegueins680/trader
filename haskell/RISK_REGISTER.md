...
| FEATURE-MISSINGNESS-001 | Optional predictor features can encode unavailable evidence as the same numeric zero as an observed value | HIGH | trader-firm-research | OPEN | Migrate production feature builders and artifacts to the tested `feature_availability_v2` timestamp/mask contract before any affected learned predictor is promotion-eligible |
