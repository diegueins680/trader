...
optimizerArgsParser =
    OptimizerArgs
        ...
        <*> option auto (long "walk-forward-embargo-bars-min" <> value 0 <> metavar "INT")
        <*> option auto (long "walk-forward-embargo-bars-max" <> value 0 <> metavar "INT")
        ...
        <*> option auto (long "router-score-pnl-weight-max" <> value 0.5 <> metavar "FLOAT")
