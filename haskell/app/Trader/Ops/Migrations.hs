...
migrations =
    [ Migration
        ...
        , migStatements =
            ...
            , "CREATE TABLE IF NOT EXISTS position_origins ("
                ...
                <> "opened_at_ms BIGINT,"
                <> "order_id TEXT,"
                <> "opened_server_id TEXT,"
                <> "opened_server_role TEXT,"
                <> "opened_server_provider TEXT,"
                <> "updated_at_ms BIGINT,"
            ...
            , "ALTER TABLE ops ADD COLUMN IF NOT EXISTS server_id TEXT"
            , "ALTER TABLE ops ADD COLUMN IF NOT EXISTS server_role TEXT"
            , "ALTER TABLE ops ADD COLUMN IF NOT EXISTS server_provider TEXT"
            , "ALTER TABLE position_origins ADD COLUMN IF NOT EXISTS opened_server_id TEXT"
            , "ALTER TABLE position_origins ADD COLUMN IF NOT EXISTS opened_server_role TEXT"
            , "ALTER TABLE position_origins ADD COLUMN IF NOT EXISTS opened_server_provider TEXT"
            ...
            , "CREATE INDEX IF NOT EXISTS ops_server_id_idx ON ops(server_id)"
            , "CREATE INDEX IF NOT EXISTS ops_server_role_idx ON ops(server_role)"
    ...
    , Migration
        { migVersion = 4
        , migDescription = "server_identity_operation_columns"
        , migStatements =
            [ "ALTER TABLE ops ADD COLUMN IF NOT EXISTS server_id TEXT"
            , "ALTER TABLE ops ADD COLUMN IF NOT EXISTS server_role TEXT"
            , "ALTER TABLE ops ADD COLUMN IF NOT EXISTS server_provider TEXT"
