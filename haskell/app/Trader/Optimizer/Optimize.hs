...
data OptimizerArgs = OptimizerArgs
    ...
    , oaKalmanPhysicsCandidateValidationRatioMin :: !Double
        ...
        cmd28 =
            cmd27
                ++ [ "--kalman-market-top-n"
                   ...
                   , "--kalman-physics-candidate-validation-ratio"
...
sampleParams
    ...
    kalmanPhysicsCandidateValidationRatioMin
    ...
    kellyLiteCapRange =
        let (platform, rng1) =
            ...
            (kalmanPhysicsCandidateValidationRatio, rng43f) =
                                            ...
                                            case barsResult of
                                                ...
                                                Right (barsMin, barsMax) -> do
                                                    let barsAutoProb = clamp (oaBarsAutoProb args) 0 1
                                                        ...
                                                        kalmanPhysicsCandidateValidationRatioMin =
                                                            clamp (oaKalmanPhysicsCandidateValidationRatioMin args) 0 0.999999
                                                        kalmanPhysicsCandidateValidationRatioMax =
                                                            max
                                                                kalmanPhysicsCandidateValidationRatioMin
                                                                (clamp (oaKalmanPhysicsCandidateValidationRatioMax args) 0 0.999999)
                                                        kalmanPhysicsSmallSampleValidationRatioMin =
                                                            clamp (oaKalmanPhysicsSmallSampleValidationRatioMin args) 0 0.999999
                                                        kalmanPhysicsSmallSampleValidationRatioMax =
                                                            max
                                                                kalmanPhysicsSmallSampleValidationRatioMin
                                                                                    ...
                                                                                    case (trOk tr0, trFinalEquity tr0, trMetrics tr0) of
                                                                                        (True, Just _, Just metrics) ->
                                                                                            let mOpenThreshold = trOpenThreshold tr0 <|> Just (tpBaseOpenThreshold params)
                                                                                                mCloseThreshold = trCloseThreshold tr0 <|> Just (tpBaseCloseThreshold params)
                                                                                                thresholdWithin (lo, hi) value =
                                                                                                    value >= lo - 1e-12 && value <= hi + 1e-12
                                                                                                openThresholdWithinActive =
                                                                                                    maybe True (thresholdWithin (openThresholdMin, openThresholdMax)) mOpenThreshold
                                                                                                closeThresholdWithinActive =
                                                                                                    maybe True (thresholdWithin (closeThresholdMin, closeThresholdMax)) mCloseThreshold
                                                                                             ...
                                                                                             in if not openThresholdWithinActive
                                                                                                    then (False, Just (printf "openThresholdOutsideActiveRange[%.6f,%.6f]" openThresholdMin openThresholdMax), Nothing)
                                                                                                    else
                                                                                                        if not closeThresholdWithinActive
                                                                                                            then (False, Just (printf "closeThresholdOutsideActiveRange[%.6f,%.6f]" closeThresholdMin closeThresholdMax), Nothing)
                                                                                                            else
                                                                                                                if not openThresholdDeployable
...
crossoverTrialParams a b rng0 =
    let (tpPlatform', rng1) = pickValue (tpPlatform a) (tpPlatform b) rng0
        ...
        (tpKalmanPhysicsCandidateValidationRatio', rng89u) =
