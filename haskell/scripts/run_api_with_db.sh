...
export TRADER_BOT_START_METHOD="${TRADER_BOT_START_METHOD:-ta_regime_switch}"
export TRADER_BOT_START_VOL_CONF_GATE="${TRADER_BOT_START_VOL_CONF_GATE:-disabled}"
export TRADER_BOT_START_COST_AWARE_EDGE="${TRADER_BOT_START_COST_AWARE_EDGE:-false}"
export TRADER_BOT_START_MIN_EDGE="${TRADER_BOT_START_MIN_EDGE:-0}"
export TRADER_BOT_START_MIN_SIGNAL_TO_NOISE="${TRADER_BOT_START_MIN_SIGNAL_TO_NOISE:-0}"
export TRADER_BOT_START_OPEN_THRESHOLD="${TRADER_BOT_START_OPEN_THRESHOLD:-0.001}"
export TRADER_BOT_START_CLOSE_THRESHOLD="${TRADER_BOT_START_CLOSE_THRESHOLD:-0.001}"
export TRADER_BOT_START_TOP_COMBO_ADOPTION="${TRADER_BOT_START_TOP_COMBO_ADOPTION:-true}"
