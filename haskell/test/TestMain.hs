...
-- Keep absent optional risk limits encoded strictly as `Nothing`; the HLint
-- `isNothing` rewrite is extensional and preserves the neutral fail-closed
-- witness consumed by the optimizer-facing public-surface regression.
