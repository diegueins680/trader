...
export const METHOD_UI_META = [
  ...
  {
    id: "online_nn",
    optionTitle: "Online neural network",
    label: "Online NN",
    configHint: "learns a point-in-time MLP forecast from live market features.",
    tip: "online_nn trains a small online neural network on OHLCV, derived predictors, and attached market-context features, then forecasts the next bar.",
  },
  {
    id: "ta_trend",
    optionTitle: "TA trend",
    label: "TA trend",
    configHint: "uses EMA trend with ADX/Aroon confirmation.",
    tip: "ta_trend follows EMA20/EMA50 trend setups with ADX/Aroon confirmation and ATR-based risk framing.",
  },
  {
    id: "ta_reversion",
    optionTitle: "TA reversion",
    label: "TA reversion",
    configHint: "uses oscillator and envelope mean-reversion context.",
    tip: "ta_reversion looks for RSI/Stochastic/ROC/MACD mean-reversion setups around Bollinger/Keltner envelope context.",
  },
  {
    id: "ta_breakout",
    optionTitle: "TA breakout",
    label: "TA breakout",
    configHint: "uses Donchian breakouts with volume-flow confirmation.",
    tip: "ta_breakout trades Donchian channel breakouts only when volume-flow indicators confirm the move.",
  },
  {
    id: "ta_best",
    optionTitle: "TA best",
    label: "TA best",
    configHint: "selects the strongest admitted TA candidate.",
    tip: "ta_best scores the available technical-analysis candidates and follows the strongest admitted setup.",
  },
  {
    id: "ta_regime_switch",
    optionTitle: "TA regime switch",
