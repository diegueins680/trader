...
| Missingness-aware calibrated shallow model | Continue research / blocked | Run the bounded public collector no earlier than 2027-01-21, verify every frozen bundle independently, complete remaining timestamp-preserving source and full candidate-artifact/builder boundaries, and do not inspect the final holdout before its one-shot gate |
